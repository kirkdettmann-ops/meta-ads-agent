    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <Badge variant="secondary">Coming in v1</Badge>
        </div>
        <p className="text-sm text-muted-foreground">
          Video-only platform — static image ads are not supported. Comedy-club content (BTS, performer roasts, short clips) is a strong fit.
        </p>
      </div>
